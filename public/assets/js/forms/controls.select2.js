...
class Select2Controls {
  ...
  _initSelect2Basic() {
    jQuery('#select2Basic').select2({placeholder: 'Pilih salah satu', maximumSelectionLength: 1});
    jQuery('#select2BasicA').select2({placeholder: 'Pilih salah satu', maximumSelectionLength: 1});
    jQuery('#select2BasicB').select2({placeholder: 'Pilih salah satu', maximumSelectionLength: 1});
    jQuery('#select2BasicC').select2({placeholder: 'Pilih rekening tujuan', maximumSelectionLength: 1});
  }
