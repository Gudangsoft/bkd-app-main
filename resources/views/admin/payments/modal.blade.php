...
<div x-data="{ open: false }"
    x-init="window.addEventListener('deleteConfirmModal', () => open = true); window.addEventListener('closeDeleteConfirmModal', () => open = false)"
...
<div x-data="{ open: false }"
    x-init="window.addEventListener('deleteSelectedConfirmModal', () => open = true); window.addEventListener('closeDeleteSelectedConfirmModal', () => open = false)"
    x-show="open" x-cloak class="relative z-40" role="dialog" aria-modal="true">
    <div x-show="open" x-transition.opacity class="fixed inset-0 bg-gray-900/40" @click="open = false"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div x-show="open" x-transition class="w-full max-w-sm rounded-2xl bg-white p-6 text-center shadow-xl">
