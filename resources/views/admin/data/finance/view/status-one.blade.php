<div>
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" aria-labelledby="defaultDropdown">
            <li><a class="dropdown-item" href="#" wire:click='updateStatusAccessorOne({{ $row->id }}, 3)'>Memenuhi</a></li>
            <li><a class="dropdown-item" href="#" wire:click='updateStatusAccessorOne({{ $row->id }}, 2)'>Penilaian belum bisa dilakukan</a></li>
            <li><a class="dropdown-item" href="#" wire:click='updateStatusAccessorOne({{ $row->id }}, 1)'>Belum ditentukan</a></li>
        </ul>
        @endrole
    </div>
</div>
