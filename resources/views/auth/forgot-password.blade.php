                ...
                <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
                    <div
                        ...
                        <div class="sw-lg-50 px-5">
                            <div class="sh-11">
                                <a href="#">
                                    <h2 class="text-primary">Reset Password {{ config('app.name') }}</h2>
                                </a>
                            </div>
                            <div class="mb-5">
                                <p class="h6">Lupa kata sandi Anda? Tidak masalah. Cukup beri tahu kami alamat email
                                    Anda dan kami akan mengirimkan email berisi tautan pengaturan ulang kata sandi
                                    sehingga Anda dapat memilih yang baru.</p>
                            </div>
                            @if ($errors->any())
